...
* **3-day free trial** — no payment required to try all Pro features.
...
= 3.0.0 =
Introduces a freemium model powered by Freemius. Core features (inline scripts, external URLs, activity log) remain free and unlimited. Conditional loading, managed JS files, REST API, WP-CLI, and the API IP allowlist now require a Pro licence. A 3-day free trial is available — no payment required.
