...
trait Scriptomatic_Renderer {
     ...
     *
     * Called from {@see inject_scripts_for()} on every front-end page load.
     * Returns `true` when the script block should be output, `false` otherwise.
     *
     ...
     * - `page_id`      — get_queried_object_id() in stored ID list.
     * - `url_contains` — REQUEST_URI contains any stored pattern.
