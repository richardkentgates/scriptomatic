    ...
    public function add_help_tab() {
        ...
        $screen->add_help_tab( array(
            ...
            'content' =>
                ...
                '<li><strong>' . __( 'Audit Logging:', 'scriptomatic' ) . '</strong> ' . __( 'All saves and AJAX rollbacks are recorded in the persistent in-admin <strong>Audit Log</strong> (Scriptomatic &rarr; Preferences). Each entry captures the timestamp, acting user, action (save or rollback), script location, and character count. The log limit is configurable in Preferences. Admins can clear the log at any time using the Clear Audit Log button.', 'scriptomatic' ) . '</li>' .
