    ...
    public function add_help_tab() {
        ...
        $screen->add_help_tab( array(
            ...
            'content' =>
                ...
                '<p>' . __( '<strong>REST API</strong> <em>(Pro)</em> — full <code>scriptomatic/v1</code> REST API (WordPress Application Passwords). <strong>WP-CLI</strong> <em>(Pro)</em> — <code>wp scriptomatic</code> command group. Both share the same validation and activity logging as the admin UI. Three API access controls in <em>Preferences</em>: enable/disable toggle, IP allowlist, and allowed-users list.', 'scriptomatic' ) . '</p>' .
