...
> 💡 A **3-day free trial** (no payment required) is available for all Pro features.
...
> **Pro feature.** REST API access requires an active Scriptomatic Pro licence. A 3-day free trial is available — no payment required.
...
> **Pro feature.** WP-CLI commands require an active Scriptomatic Pro licence. A 3-day free trial is available — no payment required.
